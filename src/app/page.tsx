          ...
          <div className="relative h-100 md:h-150 rounded-3xl overflow-hidden group">
            ...
            <div className="relative z-10 h-full flex flex-col justify-end p-4 md:p-10 text-white">
              ...
              <p className="text-sm md:text-[16px] text-white! max-w-lg mb-6 md:mb-8">
                Helipads, lighting, firefighting, and aviation safety systems
                engineered for compliance and performance
              </p>
      ...
      <section className="2xl:max-w-340 mx-auto px-4 md:px-8 py-12 md:py-16 bg-white grow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 mb-10">
          ...
          <div className="flex flex-col justify-end gap-6">
            <p className="text-sm md:text-base secondary">
              Catobo is an engineering and technical solutions group delivering
              integrated systems for aviation, construction, and industrial
              infrastructure. Company started in 2007 of operational experience,
              we enable organizations to enhance safety, productivity, and
              long-term sustainability through reliable, compliant, and
              performance-driven solutions.
            </p>
            <p className="text-sm md:text-base secondary">
              Our strength lies in combining deep engineering knowledge, a
              structured management approach, and a strong global network. This
              allows us to design, supply, and support systems that meet the
              highest technical and operational standards across safety-critical
              environments.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          ...
          <div className="md:col-span-4 rounded-2xl flex items-center justify-center min-h-40 md:min-h-70">
            ...
            <Image
              src={"/bottom.png"}
              alt="Main Page Bottom blue Image"
              width={1500}
              height={1500}
