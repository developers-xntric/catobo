...
function BodyText({
  ...
  return (
    <p className={`text-[12.5px] text-[#636363] ${className}`}>{children}</p>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="url(#paint2_linear_3112_9028)"
      />
      <path
        d="M69.1197 33.6584H63.6742C63.196 33.6584 62.7374 33.8484 62.3992 34.1866C62.0611 34.5247 61.8711 34.9834 61.8711 35.4616C61.8711 35.9398 62.0611 36.3984 62.3992 36.7366C62.7374 37.0747 63.196 37.2647 63.6742 37.2647H69.1197C69.5979 37.2647 70.0565 37.0747 70.3947 36.7366C70.7328 36.3984 70.9228 35.9398 70.9228 35.4616C70.9228 34.9834 70.7328 34.5247 70.3947 34.1866C70.0565 33.8484 69.5979 33.6584 69.1197 33.6584Z"
        fill="url(#paint3_linear_3112_9028)"
      />
      <path
        d="M56.6911 54.1301C56.3442 53.8296 55.8964 53.6716 55.4377 53.6881C54.9791 53.7045 54.5437 53.894 54.2191 54.2185C53.8946 54.5431 53.7051 54.9785 53.6887 55.4371C53.6722 55.8958 53.8302 56.3436 54.1307 56.6905L57.9894 60.5372C58.3312 60.8557 58.7833 61.0291 59.2504 61.0209C59.7176 61.0126 60.1633 60.8234 60.4936 60.493C60.824 60.1626 61.0132 59.7169 61.0215 59.2498C61.0297 58.7827 60.8563 58.3306 60.5378 57.9888L56.6911 54.1301Z"
        fill="url(#paint4_linear_3112_9028)"
      />
      <path
        d="M14.233 54.1301L10.3863 57.9888C10.0678 58.3306 9.89438 58.7827 9.90262 59.2498C9.91087 59.7169 10.1001 60.1626 10.4305 60.493C10.7608 60.8234 11.2065 61.0126 11.6737 61.0209C12.1408 61.0291 12.5929 60.8557 12.9347 60.5372L16.7934 56.6905C17.0939 56.3436 17.2518 55.8958 17.2354 55.4371C17.219 54.9785 17.0295 54.5431 16.7049 54.2185C16.3804 53.894 15.945 53.7045 15.4864 53.6881C15.0277 53.6716 14.5799 53.8296 14.233 54.1301Z"
        fill="url(#paint5_linear_3112_9028)"
      />
      <path
        d="M7.24859 33.6584H1.80313C1.32491 33.6584 0.866278 33.8484 0.528125 34.1866C0.189972 34.5247 0 34.9834 0 35.4616C0 35.9398 0.189972 36.3984 0.528125 36.7366C0.866278 37.0747 1.32491 37.2647 1.80313 37.2647H7.24859C7.72681 37.2647 8.18544 37.0747 8.52359 36.7366C8.86174 36.3984 9.05172 35.9398 9.05172 35.4616C9.05172 34.9834 8.86174 34.5247 8.52359 34.1866C8.18544 33.8484 7.72681 33.6584 7.24859 33.6584Z"
        fill="url(#paint6_linear_3112_9028)"
      />
      <path
        d="M14.2331 16.7932C14.58 17.0937 15.0278 17.2516 15.4865 17.2352C15.9451 17.2188 16.3805 17.0292 16.7051 16.7047C17.0296 16.3802 17.2191 15.9448 17.2355 15.4861C17.252 15.0274 17.094 14.5796 16.7935 14.2327L12.9348 10.386C12.7697 10.2089 12.5707 10.0668 12.3495 9.96823C12.1283 9.86968 11.8895 9.81669 11.6474 9.81241C11.4053 9.80814 11.1648 9.85268 10.9403 9.94337C10.7158 10.0341 10.5118 10.169 10.3406 10.3403C10.1694 10.5115 10.0344 10.7154 9.94373 10.94C9.85304 11.1645 9.80851 11.405 9.81278 11.6471C9.81705 11.8892 9.87004 12.1279 9.9686 12.3491C10.0671 12.5703 10.2092 12.7694 10.3864 12.9345L14.2331 16.7932Z"
        fill="url(#paint7_linear_3112_9028)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_3112_9028"
          x1="-0.0340175"
          y1="11.9368"
          x2="78.8278"
          y2="15.9949"
  ...
  return (
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_3112_9042)"
      />
      <path
        d="M7.90389 9.4417C8.11639 9.6542 8.39482 9.7604 8.67326 9.7604C8.95169 9.7604 9.23012 9.65409 9.44262 9.4417C9.86751 9.01682 9.86751 8.32786 9.44262 7.90298L6.97469 5.43494C6.5498 5.01005 5.86106 5.01005 5.43585 5.43494C5.01097 5.85982 5.01097 6.54878 5.43585 6.97367L7.90389 9.4417Z"
        fill="url(#paint1_linear_3112_9042)"
      />
      <path
        d="M18.5568 5.66655C19.1576 5.66655 19.6449 5.17943 19.6449 4.57849V1.08812C19.6449 0.487184 19.1576 6.10352e-05 18.5568 6.10352e-05C17.956 6.10352e-05 17.4688 0.487184 17.4688 1.08812V4.57849C17.4688 5.17943 17.956 5.66655 18.5568 5.66655Z"
        fill="url(#paint2_linear_3112_9042)"
      />
      <path
      ...
      <path
        ...
        fill="url(#paint5_linear_3112_9042)"
      />
      <path
        ...
        fill="url(#paint6_linear_3112_9042)"
      />
      <path
        d="M41.0953 48.9767L36.221 53.851C35.7961 54.2759 35.7961 54.9648 36.221 55.3897C36.4335 55.6022 36.7119 55.7084 36.9904 55.7084C37.2688 55.7084 37.5472 55.6021 37.7597 55.3897L42.634 50.5155C43.0589 50.0906 43.0589 49.4016 42.634 48.9767C42.209 48.5517 41.5203 48.5518 41.0953 48.9767Z"
        fill="url(#paint7_linear_3112_9042)"
      />
      <path
        ...
        fill="url(#paint8_linear_3112_9042)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_3112_9042"
          x1="-1.44952"
          y1="17.468"
          x2="7.86325"
          y2="18.9017"
    ...
    <div className="flex-1 ">
      ...
      <section id="section-0" className="mb-12">
        <SectionHeading size="h1" className="mb-4">
          Flexible. Stable. Built for Operations on Water.
        </SectionHeading>
        

        <p className="mb-3 text-[14px] md:text-[16px]  text-[#636363]">
          When permanent waterfront infrastructure is impractical, Catobo’s
          Modular Floating Solutions provide a flexible and dependable platform
          for marine, industrial, aviation and temporary applications. Designed
          around high-strength interlocking modules, the systems can be
          configured and deployed efficiently to suit different operational
          environments.
        </p>

        <p className="mb-3 text-[14px] md:text-[16px]  text-[#636363]">
          Engineered for stability, scalability and long-term durability, Catobo
          floating platforms provide a practical alternative to conventional
          fixed marine structures while allowing future expansion, relocation
          and reconfiguration as project requirements evolve.
        </p>

        {/* 2×2 check grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3 mb-8">
          {[
            "Rapid deployment on water surfaces",
            "Stable and secure platform configuration",
            "Cost-effective alternative to fixed structures",
            "Adaptable for diverse operational requirements",
          ].map((item, i) => (
        ...
        <div className="flex md:flex-row flex-col gap-3">
          <div className="md:w-[63%] rounded-xl overflow-hidden bg-gray-100 h-74">
            <img src="/pl/4.png" alt="" className="w-full h-full object-fill" />
          </div>
          <div className="md:w-[36%] rounded-xl overflow-hidden bg-gray-100 h-74">
            <img src="/pl/5.png" alt="" className="w-full h-full object-fill" />
          </div>
        </div>
      </section>
      ...
      <section id="section-1" className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <FeatureCard
            ...
            description="Interlocking modular units allow the platform to be configured around different project sizes, layouts and operational requirements, with the flexibility for future expansion."
          />
          <FeatureCard
            icon={<IconBattery />}
            title="High Load Stability"
            description="Engineered for balanced load distribution and buoyancy, the system provides a stable and secure working surface for demanding water-based operations."
          />
          <FeatureCard
            icon={<IconShield />}
            title="Durable, Marine-Ready Construction"
            description="High-quality materials and robust construction help the platform withstand challenging marine conditions while supporting long operational life and reduced maintenance requirements."
          />
        </div>
      </section>
      ...
      <section id="section-2" className="mb-12">
        ...
        <p className="text-[13.5px] font-medium text-[#1a1a1a] mb-2">
          Designed for Demanding Water Environments
        </p>

        <BodyText className="mb-5">
          Catobo’s modular floating systems combine structural strength,
          operational efficiency and flexible installation to perform reliably
          across changing marine environments.
        </BodyText>

        <div className="space-y-3">
          {[
            "High-strength modular construction",
            "Optimized load distribution and stability",
            "Fast installation with minimal equipment and manpower",
      ...
      <section id="section-3" className="mb-12">
        <ProcessTimeline
          ...
          columns={4}
          steps={[
            { number: "01", title: "Marinas & Floating Docks", description: "Flexible platform solutions for marina access, floating docks and waterfront developments." },
            { number: "02", title: "Industrial & Work Platforms", description: "Stable floating surfaces for marine operations, maintenance activities and specialized industrial requirements." },
            { number: "03", title: "Temporary Floating Structures", description: "Rapidly deployable platforms for temporary facilities, events and specialized installations." },
            { number: "04", title: "Leisure & Recreational Facilities", description: "Configurable floating platforms for waterfront leisure, recreational and hospitality environments." },
          ]}
        />
      </section>
      ...
      <section id="section-4" className="mb-10">
        <div className="grid grid-cols-1 xl:grid-cols-[5fr_7fr] gap-8 items-center">
          {/* Left – image */}
          <div className="rounded-xl overflow-hidden bg-gray-100 h-90 order-2 xl:order-1">
            <img
              src="/pl/6.png"
          ...
          <div className="order-1 xl:order-2">
            <SectionHeading size="h2" className="mb-5">
              Why Choose Catobo Modular Floating Solutions?
            </SectionHeading>

            <div className="space-y-3 mb-7">
              {[
                "Fast deployment without major marine construction",
                "Modular configurations tailored to project requirements",
                "Stable performance across demanding water environments",
                "Expandable and relocatable as operational needs change",
              ].map((item, i) => (
                <CheckItem key={i} label={item} />
              ))}
            </div>
  ...
  const sidebarGroups: SidebarGroup[] = [
    {
      items: [
        ...
        { label: "Performance", hasArrow: true },
