...
function IconModular() {
  return (
    ...
    >
      <path
        d="M30.8286 12.2493H37.85L28.2148 21.8849L30.38 24.05L40.0155 14.4149V21.4363H43.0779V9.18701H30.8286V12.2493Z"
        fill="url(#paint0_linear_3112_9209)"
      />
      <path
        d="M46.1406 0V3.06232H49.2029V6.12464H52.2653V0H46.1406Z"
        fill="url(#paint1_linear_3112_9209)"
      />
      <path
        d="M49.2029 39.8102H46.1406V42.8725H52.2653V36.7479H49.2029V39.8102Z"
        fill="url(#paint2_linear_3112_9209)"
      />
      <path
        d="M49.1992 9.18701H52.2615V15.3117H49.1992V9.18701Z"
        fill="url(#paint3_linear_3112_9209)"
      />
      <path
        d="M49.1992 18.374H52.2615V24.4986H49.1992V18.374Z"
        fill="url(#paint4_linear_3112_9209)"
      />
      <path
        d="M49.1992 27.5609H52.2615V33.6856H49.1992V27.5609Z"
        fill="url(#paint5_linear_3112_9209)"
      />
      <path
        d="M12.4529 3.06232H15.5153V0H9.39062V6.12464H12.4529V3.06232Z"
        fill="url(#paint6_linear_3112_9209)"
      />
      <path
        d="M9.39062 9.18701H12.4529V15.3117H9.39062V9.18701Z"
        fill="url(#paint7_linear_3112_9209)"
      />
      <path
        d="M9.39062 18.374H12.4529V24.4986H9.39062V18.374Z"
        fill="url(#paint8_linear_3112_9209)"
      />
      <path
        d="M18.5781 0H24.7028V3.06232H18.5781V0Z"
        fill="url(#paint9_linear_3112_9209)"
      />
      <path
        d="M27.7656 0H33.8903V3.06232H27.7656V0Z"
        fill="url(#paint10_linear_3112_9209)"
      />
      <path
        d="M36.9531 0H43.0778V3.06232H36.9531V0Z"
        fill="url(#paint11_linear_3112_9209)"
      />
      <path
        d="M27.7656 39.8102H33.8903V42.8726H27.7656V39.8102Z"
        fill="url(#paint12_linear_3112_9209)"
      />
      <path
        d="M36.9531 39.8102H43.0778V42.8726H36.9531V39.8102Z"
        fill="url(#paint13_linear_3112_9209)"
      />
      <path
        d="M0 52.2636H24.4986V27.7651H0V52.2636ZM3.06232 30.8274H21.4363V49.2013H3.06232V30.8274Z"
        fill="url(#paint14_linear_3112_9209)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_3112_9209"
          x1="24.4128"
          y1="9.18701"
          x2="49.3318"
          y2="10.6603"
...
function IconLoad() {
  return (
    ...
    >
      <path
        d="M48.1121 40.1015L44.3381 18.7394C43.5569 14.3179 39.7311 11.1088 35.2412 11.1088H29.902C30.7093 9.96131 31.1852 8.56477 31.1852 7.05827C31.1853 3.16645 28.0188 0.00012207 24.127 0.00012207C20.2351 0.00012207 17.0687 3.16645 17.0687 7.05837C17.0687 8.56487 17.5446 9.96141 18.3519 11.1089H13.0127C8.52287 11.1089 4.69703 14.318 3.91582 18.7395L0.141814 40.1015C-0.334514 42.798 0.40162 45.5475 2.16126 47.6453C3.92099 49.7433 6.50055 50.9464 9.23881 50.9464H39.0153C41.7536 50.9464 44.3331 49.7432 46.0928 47.6454C47.8525 45.5476 48.5883 42.798 48.1121 40.1015ZM24.127 3.00784C26.3604 3.00784 28.1775 4.82489 28.1775 7.05837C28.1775 9.29185 26.3603 11.1089 24.127 11.1089C21.8936 11.1089 20.0764 9.29185 20.0764 7.05837C20.0764 4.82489 21.8935 3.00784 24.127 3.00784ZM43.7883 45.7125C42.6016 47.1273 40.8619 47.9387 39.0153 47.9387H9.23881C7.39221 47.9387 5.65247 47.1273 4.46578 45.7125C3.27909 44.2976 2.78256 42.4432 3.10386 40.6248L6.87787 19.2628C7.40474 16.2809 9.98489 14.1165 13.0128 14.1165H35.2414C38.2694 14.1165 40.8496 16.2807 41.3764 19.2626L45.1504 40.6247C45.4716 42.4432 44.9749 44.2976 43.7883 45.7125Z"
        fill="url(#paint0_linear_3112_9225)"
      />
      <path
        d="M19.1817 31.0274L22.9503 27.1333C23.5279 26.5366 23.5122 25.5845 22.9153 25.0069C22.3184 24.4291 21.3664 24.445 20.7887 25.0417L16.5742 29.3967V26.0875C16.5742 25.257 15.9009 24.5836 15.0703 24.5836C14.2398 24.5836 13.5664 25.257 13.5664 26.0875V35.9674C13.5664 36.798 14.2398 37.4713 15.0703 37.4713C15.9009 37.4713 16.5742 36.798 16.5742 35.9674V32.6582L20.7887 37.0132C21.0837 37.3181 21.4764 37.4713 21.8697 37.4713C22.2462 37.4713 22.6233 37.3307 22.9153 37.0481C23.5122 36.4705 23.5277 35.5186 22.9503 34.9216L19.1817 31.0274Z"
        fill="url(#paint1_linear_3112_9225)"
      />
      <path
        d="M33.1843 29.9486H30.9268C30.0962 29.9486 29.4229 30.622 29.4229 31.4525C29.4229 32.2831 30.0962 32.9564 30.9268 32.9564H31.6556C31.5124 33.8107 30.7678 34.4637 29.8733 34.4637C28.8769 34.4637 28.0662 33.6531 28.0662 32.6566V29.3986C28.0662 28.4022 28.8769 27.5915 29.8733 27.5915C30.4339 27.5915 30.9536 27.8455 31.2994 28.2885C31.8104 28.943 32.7555 29.0596 33.4102 28.5486C34.0648 28.0374 34.1814 27.0924 33.6704 26.4378C32.7508 25.2597 31.3668 24.5839 29.8734 24.5839C27.2185 24.5839 25.0586 26.7439 25.0586 29.3987V32.6567C25.0586 35.3116 27.2185 37.4715 29.8734 37.4715C32.5283 37.4715 34.6882 35.3116 34.6882 32.6567V31.4527C34.6882 30.622 34.0149 29.9486 33.1843 29.9486Z"
        fill="url(#paint2_linear_3112_9225)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_3112_9225"
          x1="-12.3436"
          y1="0.000120846"
          x2="68.5866"
          y2="4.53209"
...
function IconWeather() {
  return (
    ...
    >
      <path
        d="M4.57843 17.468H1.08806C0.487232 17.468 0 17.9551 0 18.5561C0 19.157 0.487232 19.6441 1.08806 19.6441H4.57843C5.17926 19.6441 5.66649 19.157 5.66649 18.5561C5.66649 17.9551 5.17937 17.468 4.57843 17.468Z"
        fill="url(#paint0_linear_3112_9198)"
      />
      <path
        d="M7.90389 9.44177C8.11639 9.65426 8.39482 9.76046 8.67326 9.76046C8.95169 9.76046 9.23012 9.65415 9.44262 9.44177C9.86751 9.01688 9.86751 8.32792 9.44262 7.90304L6.97469 5.435C6.5498 5.01011 5.86106 5.01011 5.43585 5.435C5.01097 5.85988 5.01097 6.54884 5.43585 6.97373L7.90389 9.44177Z"
        fill="url(#paint1_linear_3112_9198)"
      />
      <path
        fill="url(#paint4_linear_3112_9198)"
      />
      <path
        d="M18.3804 48.9768L13.5062 53.8511C13.0813 54.2759 13.0813 54.9649 13.5062 55.3898C13.7187 55.6023 13.9971 55.7085 14.2755 55.7085C14.554 55.7085 14.8324 55.6022 15.0449 55.3898L19.9192 50.5155C20.3441 50.0906 20.3441 49.4017 19.9192 48.9768C19.4942 48.5518 18.8054 48.5519 18.3804 48.9768Z"
        fill="url(#paint5_linear_3112_9198)"
      />
      <path
        d="M29.7359 48.9768L24.8616 53.8511C24.4367 54.2759 24.4367 54.9649 24.8616 55.3898C25.0741 55.6023 25.3526 55.7085 25.631 55.7085C25.9094 55.7085 26.1879 55.6022 26.4004 55.3898L31.2746 50.5155C31.6995 50.0906 31.6995 49.4017 31.2746 48.9768C30.8496 48.5518 30.1609 48.5519 29.7359 48.9768Z"
        fill="url(#paint6_linear_3112_9198)"
      />
      <path
        d="M41.0953 48.9768L36.221 53.8511C35.7961 54.2759 35.7961 54.9649 36.221 55.3898C36.4335 55.6023 36.7119 55.7085 36.9904 55.7085C37.2688 55.7085 37.5472 55.6022 37.7597 55.3898L42.634 50.5155C43.0589 50.0906 43.0589 49.4017 42.634 48.9768C42.209 48.5518 41.5203 48.5519 41.0953 48.9768Z"
        fill="url(#paint7_linear_3112_9198)"
      />
      <path
        d="M38.7521 16.7408C39.0384 16.7408 39.319 16.6244 39.5214 16.422C39.7238 16.2196 39.8402 15.9389 39.8402 15.6528C39.8402 15.3666 39.7239 15.0859 39.5214 14.8835C39.319 14.6811 39.0384 14.5647 38.7521 14.5647C38.466 14.5647 38.1852 14.6811 37.9818 14.8835C37.7795 15.0859 37.6641 15.3666 37.6641 15.6528C37.6641 15.9389 37.7795 16.2196 37.9818 16.422C38.1852 16.6244 38.4661 16.7408 38.7521 16.7408Z"
        fill="url(#paint8_linear_3112_9198)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_3112_9198"
          x1="-1.44952"
          y1="17.468"
          x2="7.86325"
          y2="18.9017"
    ...
    <div className="bg-[#F3F3F3] rounded-2xl p-5 flex flex-col gap-3">
      ...
      <ul className="space-y-1.5">
        {bullets.map((b, i) => (
          <li
            key={i}
            className="flex items-start gap-2 text-[13px] text-[#636363] leading-snug"
          >
    ...
    <div className="w-full lg:w-90 lg:shrink-0 bg-[#F3F3F3] p-5 rounded-2xl lg:sticky lg:top-8">
      ...
      <div className="flex flex-col gap-2">
        {groups.map((group, gi) => (
          <div key={gi}>
            {group.heading && (
              <h2 className="text-[1.1rem] text-black font-medium tracking-wide leading-snug mb-4">
                {group.heading}
              </h2>
            )}
            <div className="flex flex-col gap-2">
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`text-[0.875rem] leading-snug font-normal tracking-wide pr-3 whitespace-pre-line ${
...
function LightingFeatureCard({
  ...
  return (
    <div className="flex h-full flex-col gap-3 rounded-2xl bg-[#F3F3F3] p-5">
      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-transparent">
        {icon}
      </div>
      <h3 className="text-[14px] xl:text-[20px] font-semibold leading-snug tracking-wide text-[#1a1a1a]">
        {title}
      </h3>
      <BodyText className="text-[13px] xl:text-[14px] leading-snug">
        {description}
      </BodyText>
    </div>
  );
  ...
  const lightingFeatures = [
    {
      ...
      description:
        "Ultra-high-intensity LEDs provide exceptional visibility with minimal power consumption, delivering long operational life and reduced maintenance requirements.",
    },
    {
      icon: (
        <img
          src="/phls/lighting-portable.svg"
          alt=""
          className="h-11 w-11 object-contain"
        />
      ),
      ...
      description:
        "Built-in rechargeable lithium-ion batteries enable completely independent operation with no external power or cabling required.",
    },
    {
      icon: (
        <img
          src="/phls/lighting-weather.svg"
          alt=""
          className="h-11 w-11 object-contain"
        />
      ),
      ...
      description:
        "Manufactured with hard-anodized aluminum housing and sealed construction, the system is resistant to corrosion, shock, UV exposure, and extreme environmental conditions.",
    },
  ];
  const lightingApplications = [
  ...
  return (
    <div className="min-w-0 flex-1 max-w-240">
      <section id="section-0" className="mb-12">
        ...
        <p className="mb-3 text-[14px] text-[#636363] md:text-[16px]">
          When permanent power infrastructure isn’t available or time is
          critical Catobo’s Portable Lighting Solutions deliver dependable,
          compliant, and high-performance illumination for aviation and
          emergency environments. Designed for fast deployment and harsh
          conditions, our portable systems ensure uninterrupted operations when
          it matters most.
        </p>
        <p className="mb-5 text-[14px] text-[#636363] md:text-[16px]">
          Catobo’s portable lighting systems are engineered for temporary,
          emergency, and expedited aviation operations. Whether supporting
          emergency response, temporary helipads, or rapid airfield setups, our
          solutions combine durability, visibility, and operational efficiency
          in one compact system.
        </p>
        {checks([
          "Temporary helipads and vertipads",
          "Portable runway and taxiway lighting",
          "Emergency and medivac operations",
          "Rapid-deployment aviation environments",
        ])}
        <div className="mt-8 grid lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 h-72 overflow-hidden rounded-xl bg-gray-100">
            <img
              src="/phls/lighting-overview.png"
              alt="Portable aviation lighting in operation"
              className="h-full w-full object-cover"
            />
          </div>
          <div className="h-72 overflow-hidden rounded-xl bg-gray-100">
            <img
              src="/phls/lighting-detail.png"
              alt="Portable lighting unit"
              className="h-full w-full object-cover"
            />
          </div>
        </div>
      ...
      <section id="section-1" className="mb-12">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {lightingFeatures.map((card) => (
            <LightingFeatureCard key={card.title} {...card} />
          ))}
        </div>
      </section>
      <section id="section-2" className="mb-12">
        ...
        <p className="mb-2 text-[16px] font-medium text-[#1a1a1a]">
          Simple On-Site Operation
        </p>
        <BodyText className="mb-5 text-[14px] md:text-[16px]">
          Intuitive controls allow quick activation and immediate deployment,
          minimizing setup time during critical operations.
        </BodyText>
        {checks([
      ...
      <section id="section-4" className="mb-12">
        <div className="grid items-center gap-8 md:grid-cols-[5fr_7fr]">
          <div className="order-2 h-90 overflow-hidden rounded-xl bg-gray-100 md:order-1">
            <img
              src="/phls/why-lighting.png"
              alt="Portable lighting system supporting helicopter operations"
              className="h-full w-full object-cover"
            />
          </div>
...
// MAIN PAGE EXPORT// MAIN PAGE EXPORT
  ...
  return (
    <div>
      <DynamicHero
        ...
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Portable Helipads & Lighting Solutions" },
        ]}
        backgroundImage="/phls/hero.png"
      />
