...
export const aviationAboutData: AboutData = {
  trustedSolutions: {
    ...
    description:
      "Our mission is to deliver reliable, innovative, and compliant engineering solutions that enhance safety, productivity, and sustainability across industries. ",
    cards: [
      {
  ...
  engineeringExcellence: {
    ...
    paragraphs: [
      <p key="1">
        ...
        highly internationalized engineering and technical solutions group. We
        support critical industries by enhancing productivity, safety, and
        sustainability through well-integrated systems and expert-led execution.
      </p>,
      <p key="2">
        Our strength lies in a unique management approach, deep technical
        knowledge, and extensive global experience across diverse business
        activities. These elements form the foundation of our operational
        success what we call our Nucleus for Success. Guided by a
        forward-thinking philosophy, Catobo continuously develops, integrates,
        and applies knowledge, information, and technology to meet evolving
        industry demands and improve modern operational environments.
      </p>,
      <p key="3">
        We deliver end-to-end solutions across key domains, including cable
        containment systems, aircraft warning lights, airfield lighting,
        helideck and helipad lighting systems, lightning protection systems, and
