...
const footerData = {
    ...
    locationSection: {
        ...
        address: 'Office No. 702 | Al Masaood Tower | Deira | P. O. Box 120047 | Dubai – United Arab Emirates',
                ...
                <div className="mx-auto max-w-350 w-[90%] py-5 md:pt-8 md:pb-4">
                    <div className="grid grid-cols-1 gap-5 md:gap-12 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
                        ...
                        <div>
                            ...
                            >
                                Office No. 702 | Al Masaood Tower | Deira |<br />
                                P. O. Box 120047 | Dubai – United Arab Emirates
                            </a>
                        </div>
